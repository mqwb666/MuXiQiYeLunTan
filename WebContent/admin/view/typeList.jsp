...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"TypeServlet?method=TypeList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        remoteSort: false,
	 		columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'类别',width:200, sortable: true},
 		        {field:'info',title:'类别简介',width:200},
	 		]], 
	        toolbar: "#toolbar",
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除选中的数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "TypeServlet?method=DeleteType",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "TypeServlet?method=AddType",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "TypeServlet?method=EditType",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;margin-top:4px;" class="datagrid-btn-separator" >&nbsp;&nbsp;类别名：<input id="search_type_name" class="easyui-textbox" name="search_type_name" /></div>
